...
2. Launch QEMU with memory-backend-memfd:
   ...
   qemu-system-x86_64 \
     ...
     -device '{"driver":"vfio-user-pci","socket":{"path":"/tmp/vfio-user-pvrdma.sock","type":"unix"}}'
   ```
...
### Device Not Found
- Ensure the vfu_pvrdma server is running
- Check socket permissions: `sudo chmod 666 /tmp/vfio-user-pvrdma.sock`
...
- vfu_pvrdma server: `../src/vfu_pvrdma.c`
