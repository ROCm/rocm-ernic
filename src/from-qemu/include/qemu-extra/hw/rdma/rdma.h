 ...
 * Note: These are forward declarations for functions implemented in QEMU source files
 */
...
int rdma_rm_init(struct RdmaDeviceResources *rdma_dev_res, struct ibv_device_attr *dev_attr);
void rdma_rm_fini(struct RdmaDeviceResources *rdma_dev_res, struct RdmaBackendDev *backend_dev, const char *ifname);
